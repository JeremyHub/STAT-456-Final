...
# Reshaping the data
We then have to reshape the data into a 2d array and get rid of the column names. The 2d array's new shape is such that each row is its own array, and then those are all in one list. The new list as a shape of 
