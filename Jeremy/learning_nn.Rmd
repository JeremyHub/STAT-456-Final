...
Since the `mae` is 59238.68, this means that the average absolute difference between the predicted house prices and the actual house prices in the test dataset is approximately $60K. 
...
```{r}
# code below is an example of model parameters for a categorical output
model %>% compile(
