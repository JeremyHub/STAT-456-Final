...
Now try predicting the make of a car.
...
cars_data_clean <- cars_data %>%
  ...
  select(-Fuel.Type,-Transmission,-Location,-Color,-Drivetrain,-Model) %>%
  na.omit()
...
model %>% 
  ...
  ...
  layer_dense(units = 10, activation = 'softmax') # keep this as your final layer
```
